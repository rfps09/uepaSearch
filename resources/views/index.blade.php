    ...
    <div class="container">
        ...
        <div class="row justify-content-md-center mt-3">
            <div class="col col-lg-5 d-flex justify-content-between bg-white rounded p-3">
                <div>
                    <h5>Anderson Costa</h5>
                    <span class="text-muted">anderson@ander.com</span><br>
                    <span class="text-muted">(91) 9 9999-9999</span>
                </div>
                <div class="col col-lg-4 bg-primary rounded text-wrap text-white p-1">
                    Linguagens formais, outras tags de especialidade
                </div>
                <div class="d-flex align-items-center">
                    <a href="{{route('editar')}}" class="p-2"><i class="bi bi-pencil-square"></i></a>
